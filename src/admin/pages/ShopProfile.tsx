...
import { Store, MapPin, Phone, Mail, Instagram, Clock, CheckCircle, Loader2, Link as LinkIcon, Camera, LayoutTemplate } from 'lucide-react';
    ...
    <div className="p-4 lg:p-8 pt-20 lg:pt-8 w-full max-w-5xl mx-auto min-h-screen pb-24 lg:pb-8">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
        ...
        <div className="flex items-center gap-3">
            <span className="text-sm font-semibold bg-stone-100 px-3 py-1.5 rounded-lg border border-stone-200">ID: {profile.id}</span>
            <button 
              onClick={handleSave}
              disabled={isSaving}
