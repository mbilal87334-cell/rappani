            ...
            {cart.length > 0 && (
              <div className="p-6 border-t border-stone-100 bg-stone-50">
                ...
                <div className="bg-white p-4 rounded-xl border border-stone-200 mb-4 flex flex-col items-center justify-center shadow-inner">
                  ...
                  <img
                    src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(`upi://pay?pa=6384137974@ptaxis&pn=RappaniStore&am=${Math.round(cartTotalAmount)}&cu=INR`)}`}
                    alt="Scan to Pay"
                ...
                <a
                  href={`upi://pay?pa=6384137974@ptaxis&pn=RappaniStore&am=${Math.round(cartTotalAmount)}&cu=INR`}
