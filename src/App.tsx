        ...
        {currentTab === 'account' && (
           <div className="space-y-6">
             ...
             <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mt-4">
                ...
                <a href="https://wa.me/918189940301" target="_blank" rel="noreferrer" className="p-4 border-b border-gray-50 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                   ...
                   <div className="flex-1">
                     ...
                     <p className="text-xs text-gray-500">+91 8189940301</p>
                   </div>
                </a>
                <a href="mailto:rappaniazzam@gmail.com" className="p-4 border-b border-gray-50 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                   ...
                   <div className="flex-1">
                     ...
                     <p className="text-xs text-gray-500">rappaniazzam@gmail.com</p>
                   </div>
                </a>
                <a href="https://instagram.com/mr_rappani" target="_blank" rel="noreferrer" className="p-4 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                   ...
                   <div className="flex-1">
                     ...
                     <p className="text-xs text-gray-500">@mr_rappani</p>
                   </div>
                </a>
             </div>
