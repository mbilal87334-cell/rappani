...
function VisitorPanel({ products, settings, setProducts, hasMore, isLoadingMore, loadMoreProducts, apiCategories }: { products: Product[], settings: Record<string, string>, setProducts: React.Dispatch<React.SetStateAction<Product[]>>, hasMore?: boolean, isLoadingMore?: boolean, loadMoreProducts?: () => void, apiCategories: any[] }) {
  ...
  return (
    <div className="bg-stone-50 font-sans text-gray-900 pb-20 min-h-screen max-w-md md:max-w-6xl mx-auto shadow-2xl relative overflow-x-hidden border-x border-gray-200">
        ...
        {currentTab === 'account' && (
           <div className="space-y-6">
             ...
             <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mt-4">
                ...
                <a href={`https://wa.me/${settings.admin_phone?.replace(/\\D/g, '') || '918189940301'}`} target="_blank" rel="noreferrer" className="p-4 border-b border-gray-50 flex items-center gap-4 hover:bg-stone-50 transition-colors">
      ...
      <a href={`https://wa.me/${settings.admin_phone?.replace(/\\D/g, '') || '918189940301'}`} target="_blank" rel="noreferrer" className="fixed bottom-24 right-4 z-50 bg-black text-white p-3.5 rounded-full shadow-lg hover:bg-black transition-colors flex items-center justify-center animate-bounce">
